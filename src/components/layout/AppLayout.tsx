  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full">
        <AppSidebar />
        <SidebarInset>
<header className="h-14 sticky top-0 z-10 flex items-center gap-2 border-b bg-background/10 backdrop-blur px-3 bg-gradient-to-r from-primary/5 via-transparent to-primary/5 shadow-sm">
